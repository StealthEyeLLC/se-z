...
const outputPath = path.resolve(root, outputArgument?.slice('--output='.length) ?? 'evidence/phase2/baby-protected-readback.json');
...
const result = {
  schemaVersion: '1.0.0', kind: 'phase2-baby-protected-configuration-readback', capturedAt: new Date().toISOString(), baselineCapturedAt: baseline.capturedAt,
  ...
  protectedConfigurationReadback: { unitDefinitions: true, dropIns: true, releasePointers: true, socketMetadata: true, installedManifestDigests: true, publicEndpointPresence: true, credentialContentsRead: false, credentialValuesCaptured: false },
